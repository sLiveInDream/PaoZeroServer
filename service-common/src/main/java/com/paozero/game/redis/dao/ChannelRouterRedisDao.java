...
import com.paozero.game.constant.RedisSystemKeyDefine;
...
public class ChannelRouterRedisDao {
    ...
    public void putRouterAddress(String channelKey, String serviceName, String address){
        String key = String.format(RedisSystemKeyDefine.CHANNEL_ROUTER_MAP_KEY, channelKey);
        redisTemplate.opsForHash().put(key, serviceName, address);
        redisTemplate.expire(key, RedisSystemKeyDefine.CHANNEL_ROUTER_MAP_EXPIRE_DAYS, TimeUnit.DAYS);
    }
